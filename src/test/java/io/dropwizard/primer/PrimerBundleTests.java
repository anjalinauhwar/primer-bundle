...
public class PrimerBundleTests extends BaseTest {
    ...
    public void testWhitelistedUrl() {
        val result = resources.client()
                .target("/simple/noauth/test")
                .request()
                .get(Response.class);
    ...
    public void testVerifyCall() throws JsonProcessingException {
        ...
        try {
            final VerifyResponse verifyResponse = primerClient.verify("test", "test", "test", ServiceUser.builder()
                    .id("test")
                    .name("test")
                    .role("test")
                    .build());
